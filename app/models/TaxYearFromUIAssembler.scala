...
case class TaxYearFromUIAssembler(checkboxYearOptions: List[String]) {
  ...
  val mapping: Map[String, (LocalDate, LocalDate)] = Map(
    "2024" -> (TAX_YEAR_2024_START_DATE, TAX_YEAR_2024_END_DATE),
    "2023" -> (TAX_YEAR_2023_START_DATE, TAX_YEAR_2023_END_DATE),
    "2022" -> (TAX_YEAR_2022_START_DATE, TAX_YEAR_2022_END_DATE),
    "2021" -> (TAX_YEAR_2021_START_DATE, TAX_YEAR_2021_END_DATE),
    "2020" -> (TAX_YEAR_2020_START_DATE, TAX_YEAR_2020_END_DATE)
  )
  ...
  val containsCurrent: Boolean = checkboxYearOptions.contains("2024")
  val contains2023: Boolean = checkboxYearOptions.contains("2023")
  val contains2022: Boolean = checkboxYearOptions.contains("2022")
  val contains2021: Boolean = checkboxYearOptions.contains("2021")
  val contains2020: Boolean = checkboxYearOptions.contains("2020")
