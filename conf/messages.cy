...
disclaimer.your.claim.details.header = Manylion eich hawliad
disclaimer.your.claim.details.year.label = Gallwch hawlio a chael rhyddhad treth ar dreuliau o £6 yr wythnos am flynyddoedd treth llawn:
disclaimer.your.claim.date.to = i
disclaimer.your.claim.text.1 = Gallwch hefyd hawlio a chael rhyddhad treth ar dreuliau o £4 yr wythnos am ran o flwyddyn dreth:
disclaimer.your.claim.text.date.bullet = 1 Ionawr 2020 i 5 Ebrill 2020
disclaimer.your.claim.text.2 = Os yw’ch costau ychwanegol yn fwy na hyn, gallwch wneud hawliad am ragor o ryddhad treth.
disclaimer.your.claim.text.3 = Bydd angen i chi
disclaimer.your.claim.text.4 = hawlio rhyddhad treth ar gyfer treuliau cyflogaeth
disclaimer.your.claim.text.5 = a darparu tystiolaeth, fel derbynebau a biliau manwl a gwiriadwy.
disclaimer.submit.button = Derbyn ac yn eich blaen

yourTaxRelief.title = Mae’n rhaid i chi ddarllen y canlynol cyn gwneud hawliad
yourTaxRelief.heading = Mae’n rhaid i chi ddarllen y canlynol cyn gwneud hawliad
yourTaxRelief.heading.after = Hawlio rhyddhad treth ar neu ar ôl 6
yourTaxRelief.notification.title = Mae’r arweiniad wedi newid ar gyfer y flwyddyn dreth newydd
yourTaxRelief.notification.text = Mae’r arweiniad ynghylch hawlio rhyddhad treth am weithio gartref wedi newid ar gyfer treuliau sy’n codi ar neu ar ôl 6 Ebrill 2022.
yourTaxRelief.info.text.1 = Gallwch hawlio os nad yw’ch cyflogwr eisoes wedi talu’ch treuliau a’ch bod wedi mynd i gostau ychwanegol ar eich aelwyd o ganlyniad i weithio gartref.
yourTaxRelief.info.text.2 = Ni allwch hawlio rhyddhad treth os mai’r cyfan a wnaethoch oedd dewis gweithio gartref.
yourTaxRelief.bullet.heading = Mae’n rhaid i un o’r canlynol fod yn berthnasol hefyd:
yourTaxRelief.bullet.text.1 = nid oes cyfleusterau priodol ar gael i chi gyflawni’ch swydd ar safle’ch cyflogwr
yourTaxRelief.bullet.text.2 = mae natur y swydd yn mynnu eich bod yn byw mor bell o safle’ch cyflogwr fel ei bod yn afresymol i chi deithio i’r safle hwnnw’n ddyddiol
yourTaxRelief.bullet.text.3 = mae’n ofynnol i chi, o dan gyfyngiadau’r llywodraeth, weithio gartref
yourTaxRelief.heading.before = Hawlio rhyddhad treth ar neu cyn 5
yourTaxRelief.bullet.heading.1 = Gallwch wneud hawliad os yw pob un o’r canlynol yn berthnasol:
yourTaxRelief.bullet.text.4 = nid yw’ch cyflogwr wedi talu’ch treuliau’n barod
yourTaxRelief.bullet.text.5 = mae canllawiau’r llywodraeth neu’ch cyflogwr wedi mynnu eich bod yn gweithio gartref neu’n hunanynysu
yourTaxRelief.bullet.text.6 = mae costau’ch aelwyd wedi cynyddu o ganlyniad i weithio gartref
yourTaxRelief.warning.text.1 = Mae’r arweiniad wedi newid ar gyfer y flwyddyn dreth newydd.
yourTaxRelief.warning.text.2 = Mae’n rhaid i chi sicrhau eich bod yn bodloni’r rheolau ar gyfer hawlio, gan y gallech gael eich erlyn os byddwch yn rhoi gwybodaeth anwir neu gamarweiniol yn fwriadol.
yourTaxRelief.accept.text.1 = Drwy glicio ar ‘Derbyn ac yn eich blaen’, rydych yn derbyn eich bod yn bodloni’r rheolau ar gyfer y blynyddoedd rydych yn hawlio amdanynt.
yourTaxRelief.button.text = Derbyn ac yn eich blaen
...
submitYourClaim.list.text = Drwy gyflwyno’r hawliad hwn am ryddhad treth, rydych yn cadarnhau’r canlynol:
submitYourClaim.list.item1 = nid yw’ch cyflogwr wedi talu’ch treuliau’n barod
submitYourClaim.list.item2 = rydych wedi cael eich gorfodi i weithio gartref oherwydd canllawiau’r llywodraeth neu’ch cyflogwr
submitYourClaim.list.item3 = mae’ch costau wedi cynyddu o ganlyniad i weithio gartref
...
selectTaxYearsToClaimFor.para = Mae CThEM wedi gwirio’i gofnodion, a gallwch hawlio ar gyfer y blynyddoedd canlynol.
selectTaxYearsToClaimFor.text = Mae CThEM wedi gwirio’i gofnodion, a gallwch hawlio ar gyfer y blynyddoedd canlynol.
...
whenDidYouFirstStartWorkingFromHome.error.invalidTaxYearDate = Gwnaethoch ddewis blynyddoedd blaenorol, felly mae’n rhaid i chi nodi dyddiad cyn 6 Ebrill 2021
...
cannotClaimUsingThisService.reason.year1 = 6 Ebrill 2022 i 5 Ebrill 2023 (y flwyddyn dreth hon)
cannotClaimUsingThisService.reason.year2 = 6 Ebrill 2021 i 5 Ebrill 2022
cannotClaimUsingThisService.reason.year3 = 6 Ebrill 2020 i 5 Ebrill 2021
cannotClaimUsingThisService.reason.year4 = 1 Ionawr 2020 i 5 Ebrill 2020
...
confirmation.whatHappensNext.paragraph.2 = Dylech weld newidiadau i’ch cod treth yn eich cyfrif treth personol ar ôl dau ddiwrnod gwaith.
...
confirmation.whatHappensNext.previousTaxYears.text = Byddwn yn gwirio’ch hawliad ar gyfer blynyddoedd treth blaenorol ac yn ysgrifennu atoch drwy’r post neu drwy e-bost os ydych wedi talu gormod o dreth. Does dim angen i chi gysylltu â CThEM ynglŷn â hyn.
